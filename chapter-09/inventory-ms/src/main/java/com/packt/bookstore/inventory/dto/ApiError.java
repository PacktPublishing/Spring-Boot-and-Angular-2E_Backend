...
public record ApiError(
    ...
    public static ApiError unprocessableEntity(String detail, String instance) {
        return new ApiError(ERROR_TYPE_BASE + "unprocessable-entity", "Unprocessable Entity", 422, detail, instance,
                Instant.now());
    }

    public static ApiError dataLoadingError(String detail, String instance) {
        return new ApiError(ERROR_TYPE_BASE + "data-loading-error", "Data Loading Error", 500, detail, instance,
                Instant.now());
    }
    ...
    public static ApiError internalServerError(String detail, String instance) {
        return new ApiError(ERROR_TYPE_BASE + "internal-server-error", "Internal Server Error", 500, detail, instance,
                Instant.now());
    }
}